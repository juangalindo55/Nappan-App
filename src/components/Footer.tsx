  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-6xl px-5 pt-12 pb-36 md:pt-8 md:pb-6 sm:px-8 lg:px-10">
        <div className="grid gap-10 md:grid-cols-[1.2fr_1.8fr]">
          ...
          <div className="grid gap-8 sm:grid-cols-[1.1fr_0.9fr]">
            <div>
              ...
              <ul className="mt-4 flex flex-row flex-wrap gap-x-6 gap-y-3 text-xs" style={{ fontFamily: 'var(--font-dm-sans)' }}>
        ...
        <div className="mt-8 border-t pt-4 flex flex-col md:flex-row justify-between items-center gap-4" style={{ borderColor: 'rgba(255,252,245,0.10)' }}>
          <p className="text-center md:text-left text-[11px] opacity-70" style={{ color: '#FFFCF5', fontFamily: 'var(--font-dm-sans)' }}>
            © 2025 Nappan Studio · Hecho con cariño en Monterrey
          </p>
          <Link href="/admin" className="border-b border-[#E8A345]/40 pb-0.5 text-[10px] font-bold uppercase tracking-[0.16em] text-[#FFFCF5] transition md:hover:border-[#E8A345] md:hover:text-[#E8A345]">
            Admin
          </Link>
        </div>
