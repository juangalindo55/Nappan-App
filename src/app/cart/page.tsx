...
export default function CartPage() {
    ...
    return (
        <>
        <main className="desktop-nav-offset min-h-dvh px-4 pt-5 md:px-8 md:pb-24 lg:px-10" style={{ background: 'var(--bg-primary)', color: 'var(--text-primary)', fontFamily: 'var(--font-dm-sans)', paddingBottom: '160px' }}>
